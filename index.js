...
// ---------- CONFIG ----------
const GUILD_ID = '1300277156621975632'; // Seu servidor
const DELETE_DELAY = 60 * 60 * 1000; // 1 hora
...
const commands = [
  ...
  new SlashCommandBuilder().setName('cleanmakki').setDescription('Deleta a última mensagem do Makki imediatamente'),
...
client.on('messageCreate', async message => {
  ...
  if (message.mentions.users.has(devID)) {
    ...
    setTimeout(() => sentMsg.delete().catch(() => {}), 1 * 60 * 1000); // 1 minuto
  }
});
